...
* "view the archives":http://lists.lug.boulder.co.us/pipermail/lug/
...
This is where unrelated conversation can occur; topics that many Linux users might be interested in but has little to do with Linux in particular, should be posted here instead of the general discussion list.
